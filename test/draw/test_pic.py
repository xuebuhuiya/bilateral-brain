...
# 准备绘图数据
labels = ['Row 1\n111111111111111111', 'Row 2', 'Row 3', 'Row 4', 'Row 5', 'Row 6', 'Row 7', 'Row 8', 'Row 9']
fine_ave = df['W']
coarse_ave = df['X']
fine_error = df['AA']
coarse_error = df['AB']
...
legend_elements = [Patch(facecolor='blue', edgecolor='blue', label='Fine Ave'),
                   Patch(facecolor='orange', edgecolor='orange', label='Coarse Ave')]
...
# 设置标题
ax.set_title('Fine Ave and Coarse Ave with Standard Deviation')
